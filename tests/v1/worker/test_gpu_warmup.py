...
def test_warmup_kernels_defaults_missing_optional_runner_attrs(monkeypatch):
...
def test_warmup_kernels_disables_kv_connector_when_present(monkeypatch):
    ...
    warmup_kernels(runner, lambda _: None, lambda _: None)
